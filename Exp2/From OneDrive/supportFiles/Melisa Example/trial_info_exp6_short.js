...
var n = 8; // total number of faces; this will be 40
...
//familiar faces
var old_fam_males = males.slice(0,1) //old (criminal) familiar males
var old_fam_females = females.slice(0,1); // ^^ females
var new_fam_males = males.slice(1,2); //new (innocent) familiar males
var new_fam_females = females.slice(1,2);//^^ females
...
// unfamiliar faces
var old_unfam_males = males.slice(2,3) //old (criminal) familiar males
var old_unfam_females = females.slice(2,3); // ^^ females
var new_unfam_males = males.slice(3,4); //new (innocent) familiar males
var new_unfam_females = females.slice(3,4);//^^ females
...
var female_names = shuffle(["EMILY", "JESSICA", "ASHLEY", "SARAH"]);
var male_names = shuffle(["OLIVER","GABRIEL","CARTER","LARRY"]);
...
var test_half_1 = shuffle(old_fam_faces_shuffled.slice(0,1).concat(new_fam_faces.slice(0,1)).concat(old_unfam_faces_shuffled.slice(0,1)).concat(new_unfam_faces.slice(0,1)));
var test_half_2 = shuffle(old_fam_faces_shuffled.slice(1,2).concat(new_fam_faces.slice(1,2)).concat(old_unfam_faces_shuffled.slice(1,2)).concat(new_unfam_faces.slice(1,2)));
